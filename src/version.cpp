// Copyright (c) 2012 The WarOfCoins developers
...
// for both WarOfCoinsd and WarOfCoins-qt, to make it harder for attackers to
// target servers or GUI users specifically.
const std::string CLIENT_NAME("WarOfCoins");
