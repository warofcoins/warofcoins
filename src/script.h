...
#ifndef H_WAROFCOINS_SCRIPT
#define H_WAROFCOINS_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CWarOfCoinsAddress
 */
...
public:
    ...
    // Pre-version-0.6, WarOfCoins always counted CHECKMULTISIGs
